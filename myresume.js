...
var football;
var text;
var hacker_rank_url="https://www.hackerrank.com/alishakesarwani1?hr_r=1";
var portfolio_url="https://drive.google.com/file/d/1vQjf6ZDm1UJtP4Dm3Cb9qwgdfQf_4-3W/view?usp=drive_link";
var leetCode_url="https://leetcode.com/alisha_02";
var github_url="https://github.com/alisha140202";
var linkedin_url="https://www.linkedin.com/in/alisha-kesarwani-a56011246/";
var resume_url="https://drive.google.com/file/d/1IIJ6DHkdEXoOdq1lDVZFXKi_vKpEMV20/view?usp=drive_linktf";
...
function preload(){
	...
	game.load.image('nvidiaLogo','assets/nvidiaLogo.png');
	game.load.image('nvidiaName','assets/nvidiaName.png');
	game.load.image('matlab','assets/matlab.png');
	game.load.image('Oracle','assets/Oracle.png');
	game.load.image('csi_vitap','assets/csi_vitap.png');
	...
	game.load.image('ai_virtual_mouse','assets/ai_virtual_mouse.png');
	game.load.image('weather_app','assets/weather_app.png');
	game.load.image('bits','assets/0s1s.png');
	game.load.image('you_tube_clone','assets/you_tube_clone.png');
	...
	game.load.image('launch_project','assets/launch_project.png');
	game.load.image('dice_game','assets/dice_game.png');
...
//	game.load.onLoadStart.add(loadStart, this);
  ...
  //  game.stage.scale.startFullScreen();
   ...
   game.canvas.addEventListener('touchenter', function(){ console.log("You touched here!!");}, false);
	...
	pythontext=	game.add.text(5250,h-430-60,'SQL',style_white2);
	jstext = game.add.text(5430,h-450-50,'MongoDB \n and \nFirebase',style_white2);
	ctext = game.add.text(5660,h-460-50,' Airtificial \n Intelligence',style_white2);
   ...
   //Add Explosion object pool
	...
	//Add logos
	game.add.sprite(10010,h-210,'csi_vitap').scale.setTo(0.50,0.50);
	game.add.sprite(10310,h-230,'matlab').scale.setTo(0.50,0.50);
	game.add.sprite(10620,h-235,'Oracle').scale.setTo(0.30,0.30);
	game.add.sprite(10970,h-290,'nvidiaName');
	game.add.sprite(11320,h-300,'hacker_rank').scale.setTo(0.5,0.5);

	//Add company texts.
	var style_ex = {font:"16px Arial",fill:orange,align:"center"};
	var style_exS = {font:"12px Arial",fill:orange,align:"center"};
	game.add.text(10080,h-210,"UI challenge \n organised by \n CSI VIT AP \n 2021",style_exS);
	game.add.text(10390,h-220,"Matwork Traning \nMATLAB onramp \n certification 2021",style_exS);
	game.add.text(10700,h-230,"Oracle(OCI)\n Certification \n 2022",style_ex); 
	game.add.text(11000,h-250,"Fundamentals of\n computing using\n CUDDA C/C++",style_ex);
	game.add.text(11420,h-290,"HackerRank\n 5-star-gold badge \n problem solving in \n JAVA and \n python",style_exS);
	...
	//Add projects
	game.add.sprite(12300,h-320,'ai_virtual_mouse');
	game.add.text(12280,h-490,"Developed AI Virtual Mouse\n using python\n Controling cursor over finger ",style_white);

	game.add.sprite(12760,h-300,'weather_app');
	game.add.text(12750,h-500,"Created Weather App \n using React and API in backend ",style_white);


	game.add.sprite(13350,h-300,'you_tube_clone').scale.setTo(0.6,0.6);
	game.add.text(13300,h-430,"You-tube clone\n using Firebase and React",style_white);

	game.add.sprite(13800-100,h-400,'chatBot');
	game.add.text(13850-100,h-500,"chatBot \n using python",style_white);

	
	game.add.sprite(14300,h-370,'consert');
	var ambu = game.add.sprite(14200,h-330,'singer');
	ambu.scale.setTo(0.8,0.8);
	var t = game.add.tween(ambu).to( { x:14400,}, 2000, Phaser.Easing.Back.InOut, true, 0, 2000, true);
	t.start();
	game.add.text(14200,h-500,"Worked in a team to develop Smart \nTicket Booking and music playing\n Management System called (TARANG).",style_white);

	game.add.sprite(15000,h-300,'CodePen').scale.setTo(0.9,0.9);
	game.add.text(14800,h-430,"Code-Pen \nAn Online compiler for web developers \n to develop the web page",style_white)

	
	game.add.text(base5+200,h-350,"Other Projects \n using HTML,CSS and \n Javascript only \n=>>",style_white);
    ...
    game.add.text(base5+490,h-280,"TO-DO List and calculator \n using HTML,CSS \nand Javascript",style_white);
	...
	game.add.sprite(base5+1183,h-400,'launch_project').scale.setTo(0.45,0.45);
	game.add.text(base5+1180,h-295,"Launching soon \n in the given time\n web-page ",style_position);

	
	cup2=game.add.sprite(base5+1400,-340,'cup');
	cup2.scale.setTo(0.8,0.8);
	game.add.sprite(base5+1630,h-410,'dice_game');
	game.add.text(base5+1580,h-250,"Dice game using \n HTML,CSS \n and Javascript",style_position);

	

	 cup3=game.add.sprite(base5+1820,-410,'cup');
	 game.add.sprite(base5+2080,h-410,'insta_clone');
	 game.add.text(base5+2100,h-250,"Instagram clone using \n HTML and CSS only",style_position);
	...
	game.add.text(base5+3250,h-470,"Trying to contribute towards Digital India \n by learning ways to implement my Web Development \nand AI knowledge together",{font:"30px Arial",fill:"#fff",align:"center"});

	//Add other highlights
	game.add.sprite(base6+600,h-320,'event_manager');
	game.add.text(base6+600,h-500,"Managed the \n event as Event Manager \n in Technical Fest \n held at our college",style_white);
	...
	game.add.text(base6+1240,h-500,"Was Part of team holding \n Yoga Session \n held at our School CMS \n .",style_white);
	game.add.text(base6+1400+20,h-360,"Took part in Swacch \n Bharat,Tree Plantation\n Drive held by our School",style_white);
...
//linked in profile
	...
	game.add.text(base7+720,h-120,"Click  the Logo to open Profiles ",style_white);
	...
	game.add.text(4300,h-120,"  Scored CGPA OF 7.54 in university.",style_roboto);
	
	//Add bubble
	
	bubble = game.add.sprite(9100,h+550,'psbubble');
	game.add.text(8900,h+500,"Designing Skills - UI/UX designing",style_roboto);
...
function openGmail(){
 var win = window.open("mailto:alishakesarwani14@gmail.com");
 win.focus();
}
